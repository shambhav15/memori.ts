...
export function BenchmarkChart() {
  ...
  return (
    <Card className="w-full h-full min-h-[300px] flex flex-col justify-center bg-zinc-900/40 border-white/5">
      <CardContent className="p-6">
        <h2 className="text-lg font-bold font-mono text-white mb-8 border-b border-white/10 pb-4">
